...
<head>
    ...
    <title>Ubah Sub Bab Panduan Umroh</title>
    <!-- Favicon icon -->
    ...
    <script src="https://dev.jtindonesia.com/admin/js/edit_panduan_umroh_subbab.js"></script>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Ubah Sub Bab Panduan Umroh</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Ubah Sub Bab Panduan Umroh</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ubah Sub Bab Panduan Umroh</h4>
                                <div class="col-lg-8 col-xlg-9 col-md-7">
                                <div class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Judul (Indonesia)</label>
                                        <div class="col-md-12">
                                            <input id="title-id" type="text" placeholder="Masukkan judul (Bahasa Indonesia)"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="title-ar" class="col-md-12">Judul (Arab)</label>
                                        <div class="col-md-12">
                                            <input id="title-ar" type="text" placeholder="Masukkan judul (Bahasa Arab)"
                                                class="form-control ps-0 form-control-line" name="title-ar">
                                        </div>
                                    </div>
                                    <div class="form-group">
