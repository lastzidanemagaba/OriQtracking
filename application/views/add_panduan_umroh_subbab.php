...
<head>
    ...
    <title>Tambah Sub Bab Panduan Umroh</title>
    <!-- Favicon icon -->
    ...
    <script src="https://dev.jtindonesia.com/admin/js/add_panduan_umroh_subbab.js"></script>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Tambah Sub Bab Panduan Umroh</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Tambah Sub Bab Panduan Umroh</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tambah Sub Bab Panduan Umroh</h4>
