...
<head>
	...
	<script src="https://dev.jtindonesia.com/admin/js/add_setting.js"></script>
		...
		<div class="page-breadcrumb">
			<div class="row align-items-center">
				<div class="col-md-6 col-8 align-self-center">
					<h3 class="page-title mb-0 p-0">Tambah Konfigurasi</h3>
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Tambah Konfigurasi</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="card-body">
							...
							<div class="col-lg-8 col-xlg-9 col-md-7">
								<div class="form-horizontal form-material mx-2">
									...
									<div class="form-group">
										<label for="data-type" class="col-md-12">Tipe Data</label>
										<div class="col-md-12">
											<select id="data-type" class="form-select shadow-none ps-0 border-0 form-control-line">
									...
									<div class="form-group">
										<label for="value" class="col-md-12">Nilai</label>
										<div class="col-md-12">
											<input id="value" type="text" placeholder="Masukkan nilai"
