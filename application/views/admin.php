...
<head>
    ...
    <script src="https://dev.jtindonesia.com/admin/js/admin.js"></script>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-end upgrade-btn">
                            <a href="https://dev.jtindonesia.com/admin/admin/add" class="btn btn-danger d-none d-md-inline-block text-white">Tambah</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!-- column -->
                    <div ng-app="qtracking" ng-controller="qtracking-controller" class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table user-table">
										...
										<tr ng-repeat="admin in admins">
											<td><b>{{$index+1}}</b></td>
											<td><img src="<?php echo base_url()."/userdata/"; ?>{{admin['photo']}}" width='40px' height='40px' style='border-radius: 20px;'></td>
											<td>{{admin['name']}}</td>
											<td>{{admin.email}}</td>
											<td>{{admin['password']}}</td>
											<td><div class='col-md-6 col-4 align-self-center'>
													<div class='upgrade-btn'>
														<a ng-click='editAdmin(admin.id)' class='btn btn-info d-none d-md-inline-block text-white'>Ubah</a>
													</div>
												</div>
											</td>
											<td><div class='col-md-6 col-4 align-self-center'>
													<div class='upgrade-btn'>
														<a ng-click='deleteAdmin(admin.id)' class='btn btn-danger d-none d-md-inline-block text-white'>Hapus</a>
													</div>
												</div>
											</td>
										</tr>
