...
<head>
    ...
    <title>Lihat Panduan Umroh</title>
    <!-- Favicon icon -->
    ...
    <script src="https://dev.jtindonesia.com/admin/js/panduan_umroh.js"></script>
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Lihat Panduan Umroh</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Lihat Panduan Umroh</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card" ng-app="qtracking" ng-controller="qtracking-controller">
                            <div class="card-body">
                                <h4 class="card-title">Lihat Panduan Umroh</h4>
                                <div class="table-responsive">
                                    ...
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Teks Arab:</label>
                                        <div class="col-md-12">
                                            <input id="arabic-text" type="text" placeholder="Teks Arab"
                                                class="form-control ps-0 form-control-line" name="example-email"
                                                id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Ejaan:</label>
                                        <div class="col-md-12">
                                            <input id="spelling" type="text" placeholder="Ejaan"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Arti:</label>
                                        <div class="col-md-12">
                                            <input id="meaning" type="text" placeholder="Arti"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                </div>
	...
	<input id="id" type="text" style="width: 0; height: 0; visibility: hidden;" value="<?php echo $id; ?>">
