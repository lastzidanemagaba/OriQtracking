...
<head>
    ...
    <title>Sub Bab Panduan Umroh</title>
    <!-- Favicon icon -->
    ...
    <script src="https://dev.jtindonesia.com/admin/js/panduan_umroh_subbab.js"></script>
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        ng-app="qtracking" ng-controller="qtracking-controller">
        <!-- ============================================================== -->
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Sub Bab Panduan Umroh</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Sub Bab Panduan Umroh</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-end upgrade-btn">
                            <a href="/admin/panduanumroh" class="btn btn-primary btn-rounded">
								<i class="mdi mdi-arrow-left"></i>
								<span class="hide-menu">Back</span>
							</a>
                            <a ng-click='addSubBab()'
                                class="btn btn-danger d-none d-md-inline-block text-white">Tambah Sub Bab</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Daftar Sub Bab Panduan Umroh</h4>
                                <div class="table-responsive">
                                    <table class="table user-table">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">#</th>
                                                <th class="border-top-0">Judul (Indonesia)</th>
                                                <th class="border-top-0">Judul (Arab)</th>
                                                <th class="border-top-0">Panduan</th>
										...
										<tr ng-repeat="panduanItem in panduan">
											<td>{{$index+1}}</td>
											<td>{{panduanItem.title_id}}</td>
											<td>{{panduanItem.title_ar}}</td>
											<td>
												<div class='col-md-6 col-4 align-self-center'>
													<div class='upgrade-btn'>
														<a ng-click='viewPanduanUmroh(panduanItem.id)' class='btn btn-info d-none d-md-inline-block text-white'>Lihat</a>
													</div>
												</div>
											</td>
											<td>
    ...
    <script src="https://dev.jtindonesia.com/admin/js/jquery.redirect.js"></script>
