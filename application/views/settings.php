...
<head>
	...
	<script src="https://dev.jtindonesia.com/admin/js/settings.js"></script>
		...
		<div class="page-breadcrumb">
			<div class="row align-items-center">
				<div class="col-md-6 col-8 align-self-center">
					<h3 class="page-title mb-0 p-0">Konfigurasi</h3>
				...
				<div class="col-md-6 col-4 align-self-center">
					<div class="text-end upgrade-btn">
						<a href="https://dev.jtindonesia.com/admin/settings/add"
							...
							<div class="table-responsive">
								<table class="table user-table">
									...
									<tr ng-repeat="config in configs">
										<td style="font-size: 13px;"><code>{{config.name}}</code></td>
										<td><div style="width: 150px; font-size: 13px;">{{config.description}}</div></td>
										<td style=""><textarea id="{{config.name}}" ng-value="config.value" rows="5" class="form-control ps-2 form-control-line"
															   style="padding-left: 10px; padding-right: 10px;"
															   value="{{config.value}}"></textarea></td>
										<td>
											<div class='col-md-6 col-4 align-self-center'>
												<div class='upgrade-btn'>
													<a ng-click='deleteSetting(config.id)' class='btn btn-danger d-none d-md-inline-block text-white'>Hapus</a>
												</div>
											</div>
										</td>
									</tr>
								...
								<div class='col-md-6 col-4 align-self-center'>
									<div class='upgrade-btn'>
										<a onclick="save()" class='btn btn-info d-none d-md-inline-block text-white'>Simpan</a>
									</div>
								</div>
							</div>
						</div>
