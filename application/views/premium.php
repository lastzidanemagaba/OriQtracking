...
<head>
	...
	<script src="https://dev.jtindonesia.com/admin/js/premium.js"></script>
		...
		<div class="page-breadcrumb">
			<div class="row align-items-center">
				<div class="col-md-6 col-8 align-self-center">
					<h3 class="page-title mb-0 p-0">Jadwal Sholat</h3>
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Jadwal Sholat</li>
							</ol>
						</nav>
					</div>
				</div>
				<div class="col-md-6 col-4 align-self-center">
					<div class="text-end upgrade-btn">
						<a href="https://dev.jtindonesia.com/admin/premium/add"
						   class="btn btn-danger d-none d-md-inline-block text-white">Tambah</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="card" ng-app="qtracking" ng-controller="qtracking-controller">
						<div class="card-body">
							<h4 class="card-title">Daftar Premium</h4>
							<div class="table-responsive">
								<table class="table user-table">
									<thead>
									<tr>
										<th class="border-top-0">#</th>
										<th class="border-top-0">ID Produk</th>
										<th class="border-top-0">Nama</th>
										<th class="border-top-0">Deskripsi</th>
										<th class="border-top-0">Benefit</th>
										<th class="border-top-0">Masa Berlaku</th>
									...
									<tr ng-repeat="premium in premiums">
										...
										<td>{{premium.product_description}}</td>
										<td>
											<ul>
												<li ng-repeat="benefit in premium.benefits">
													{{benefit}}
												</li>
											</ul>
										</td>
										<td>{{premium.months}} bulan</td>
										<td>
											<div class='col-md-6 col-4 align-self-center'>
												<div class='upgrade-btn'>
													<a ng-click='editPremium(premium.id)' class='btn btn-info d-none d-md-inline-block text-white'>Ubah</a>
												</div>
											</div>
										</td>
										<td>
											<div class='col-md-6 col-4 align-self-center'>
												<div class='upgrade-btn'>
													<a ng-click='deletePremium(premium.id)' class='btn btn-danger d-none d-md-inline-block text-white'>Hapus</a>
												</div>
											</div>
										</td>
									</tr>
