...
<head>
    ...
    <script src="https://dev.jtindonesia.com/admin/js/jadwal_sholat.js"></script>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar">
                <!-- Sidebar navigation-->
                <?php $this->load->view('sidebar', array('current_menu' => 'jadwal_sholat')); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-end upgrade-btn">
                            <a href="https://dev.jtindonesia.com/admin/jadwalsholat/add"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card" ng-app="qtracking" ng-controller="qtracking-controller">
                            <div class="card-body">
                                <h4 class="card-title">Daftar Jadwal Sholat</h4>
											...
											<td>
												<div class='col-md-6 col-4 align-self-center'>
													<div class='upgrade-btn'>
														<a ng-click='editJadwalSholat(schedule.id)' class='btn btn-info d-none d-md-inline-block text-white'>Ubah</a>
													</div>
												</div>
											</td>
											<td>
												<div class='col-md-6 col-4 align-self-center'>
													<div class='upgrade-btn'>
														<a ng-click='deleteJadwalSholat(schedule.id)' class='btn btn-danger d-none d-md-inline-block text-white'>Hapus</a>
													</div>
												</div>
											</td>
										</tr>
