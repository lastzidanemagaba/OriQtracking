...
<head>
    ...
    <script src="https://dev.jtindonesia.com/admin/js/edit_jadwal_sholat.js"></script>
...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Ubah Jadwal Sholat</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Ubah Jadwal Sholat</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ubah Jadwal Sholat</h4>
                                <div class="col-lg-8 col-xlg-9 col-md-7">
                                <div class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        <label for="description" class="col-md-12">Deskripsi</label>
                                        <div class="col-md-12">
                                            <input id="description" type="text" placeholder="Masukkan deskripsi"
    ...
    <input id="edited-jadwal-sholat-id" type="text" style="width: 0; height: 0; visibility: hidden;" value="<?php echo $editedJadwalSholatID; ?>">
</body>
