...
<head>
	...
	<script src="https://dev.jtindonesia.com/admin/js/add_premium.js"></script>
		...
		<div class="page-breadcrumb">
			<div class="row align-items-center">
				<div class="col-md-6 col-8 align-self-center">
					<h3 class="page-title mb-0 p-0">Tambah Premium</h3>
					<div class="d-flex align-items-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">Home</a></li>
								<li class="breadcrumb-item active" aria-current="page">Tambah Premium</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Tambah Premium</h4>
							<div class="col-lg-8 col-xlg-9 col-md-7">
								<div class="form-horizontal form-material mx-2">
									<div class="form-group">
										<label for="product-id" class="col-md-12">ID Produk</label>
										<div class="col-md-12">
											<input id="product-id" type="text" placeholder="Masukkan ID produk"
												   class="form-control ps-0 form-control-line" name="product-id" >
										</div>
									</div>
									<div class="form-group">
										<label for="product-name" class="col-md-12">Nama Produk</label>
										<div class="col-md-12">
											<input id="product-name" type="text" placeholder="Masukkan nama produk"
												   class="form-control ps-0 form-control-line" name="product-name" value="nama produk">
										</div>
									</div>
									<div class="form-group">
										<label for="product-description" class="col-md-12">Deskripsi Produk</label>
										<div class="col-md-12">
											<input id="product-description" type="text" placeholder="Masukkan deskripsi produk"
												   class="form-control ps-0 form-control-line" name="product-description" value="deskripsi produk">
										</div>
									</div>
									<div class="form-group">
										<label for="benefits" class="col-md-12">Benefit</label>
										<div class="col-md-12">
											<input id="benefits" type="text" placeholder="Masukkan benefit (pisahkan dengan koma)"
												   class="form-control ps-0 form-control-line" name="benefits" value="benefit">
										</div>
									</div>
									<div class="form-group">
										<label for="months" class="col-md-12">Masa Berlaku</label>
										<div class="col-md-12">
											<input id="months" type="text" placeholder="Masukkan masa berlaku (dalam bulan)"
												   class="form-control ps-0 form-control-line" name="months" value="1">
										</div>
									</div>
									<div class="form-group">
