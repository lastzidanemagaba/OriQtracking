...
<head>
    ...
    <script src="https://dev.jtindonesia.com/admin/js/panduan_umroh_bab.js"></script>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        <div class="text-end upgrade-btn">
                            <a href="https://dev.jtindonesia.com/admin/panduanumroh/add"
                                class="btn btn-danger d-none d-md-inline-block text-white">Tambah Bab</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <table class="table user-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Sub Bab</th>
